	...
	<div class="page-container">
		...
		<div class="left-content">
			<div class="mother-grid-inner">
			 ...
			 <div class="header-main">
							...
							<li class="dropdown profile_details_drop"><a href="#"
								...
								aria-expanded="false">
									<div class="profile_img">
										<span class="prfil-img"><img src="static/images/in4.jpg"
											alt=""> </span>
										<div class="user-name">
				...
				<!--heder end here-->
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="adddepartment">Department</a> <i
			...
			<div class="col-md-12 agile-info-stat">
				...
				<form:input type="text" path="departmentName"
									id="departmentName" class="form-control input-sm" placeholder="Department name" />
					</div>	
						</div>
						</div>			
					<footer>
		...
		$(document).ready(function() {
			 ...
			 $(window).scroll(function(){
				...
				<div class="copyrights" style="margin-top: 230px;">
					<p>
