...
<body class="bg-cyan">
	...
	<div class="body body-s">
		...
		<form:form method="POST" modelAttribute="profileData" class="sky-form"
			style="width:500px;margin-top: 170px;" id="submitForm" action="editProfileData">
			...
			<fieldset>
				...
				<section>Aadhaar Number :
					<label class="input"> <i class="icon-append icon-lock"></i>
						<form:input type="number" path="aadhaarNo" id="aadhaarNo"
							placeholder="aadhaar No " readonly="true"/> <b
				...
				<section>
					Gender : <label class="select"> </br> <form:radiobutton
							path="gender" id="gender" value="Male" label="Male" readonly="true" /> <form:radiobutton
							path="gender" id="gender" value="Female" label="Female" readonly="true" />
					</label>
				</section>
				<section>
					Designation :<label class="select"><form:select
							...
							class="form-control input-sm" id="designation" readonly="true"/></label>
					<div class="has-error">
