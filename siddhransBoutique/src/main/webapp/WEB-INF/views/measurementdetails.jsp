...
<body>
 ...
 --%>
	...
	<!--agileinfo-grap-->
	<ol class="breadcrumb">
		<li class="breadcrumb-item"><a href="addmeasurementDetails">Add Measurement Details</a> <i class="fa fa-angle-right"></i></li>
	</ol>
	<%-- <div>${message}</div> --%>
	<div class="agileinfo-grap">
		<div class="agileits-box">
						...
						<form:form method="POST" modelAttribute="measurementDetails"
							...
							<div class="row">
								<div class="form-group col-md-12">
									...
									<label class="col-md-2 control-lable" for="m_fullLength">Full Length</label>
									<div class="col-md-3">
							...
							<div class="row">
								<div class="form-group col-md-12">
									...
									<div class="col-md-3">
										<form:input type="m_wLegngth" path="m_wLegngth" id="m_wLegngth"
											class="form-control input-sm" placeholder="W/Length" />
									</div>
									<div class="has-error">
							...
							<div class="row">
								...
								<div class="form-group col-md-12">
									...
									<label class="col-md-2 control-lable" for="m_bcross">Sleeve x Loose</label>
									<div class="col-md-3">
										<form:input type="text" path="m_sleeveloose" id="m_sleeveloose"
											class="form-control input-sm" placeholder="Sleeve x Loose" />
									</div>
									<div class="has-error">
								...
								<div class="form-group col-md-12">
									...
									<label class="col-md-2 control-lable" for="m_armHole">Arm Hole</label>
									<div class="col-md-3">
								...
								<div class="form-group col-md-12">
									...
									<label class="col-md-2 control-lable" for="m_neckLow">Neck Low</label>
									<div class="col-md-3">
								...
								<div class="form-group col-md-12">
									...
									<label class="col-md-2 control-lable" for="m_neck_width">Neck Width</label>
									<div class="col-md-3">
								...
								<div class="form-group col-md-12">
									...
									<label class="col-md-2 control-lable" for="m_salwarXbottom">Salwar x Bottom</label>
									<div class="col-md-3">
										<form:input type="text" path="m_salwarXbottom" id="m_salwarXbottom"
											class="form-control input-sm" placeholder="Salwar x Bottom" />
									</div>
									<div class="has-error">
							...
							<div class="row">
								<div class="form-group col-md-12">
									...
									<label class="col-md-2 control-lable" for="m_kneeRound">Knee Round</label>
									<div class="col-md-3">
							...
							<div class="row">
								<div class="form-group col-md-12">
									...
									<label class="col-md-2 control-lable" for="m_thighRound">Thigh Round</label>
									<div class="col-md-3">
								...
								<div class="form-group col-md-12">
									...
									<label class="col-md-2 control-lable" for="m_fL">Front length</label>
									<div class="col-md-3">
								...
								<div class="form-group col-md-12">
									...
									<label class="col-md-2 control-lable" for="m_fW">Front Width</label>
									<div class="col-md-3">
							...
							<div class="row">
								<div class="form-group col-md-12">
									...
									<label class="col-md-2 control-lable" for="m_bL">Back Length</label>
									<div class="col-md-3">
								...
								<div class="form-group col-md-12">
									...
									<div class="col-md-3">
										<form:radiobutton
							path="m_fitting" id="m_fitting" value="B.Fit" label="B.Fit" /> <form:radiobutton
							path="m_fitting" id="m_fitting" value="M.Fit" label="M.Fit" /><form:radiobutton
							path="m_fitting" id="m_fitting" value="M.Loose" label="M.Loose" /><form:radiobutton
							path="m_fitting" id="m_fitting" value="Loose Fit" label="Loose Fit" />
									</div>
									<div class="has-error">
								...
								<div class="form-group col-md-12">
									...
									<label class="col-md-2 control-lable" for="m_topType">Fitting</label>
									<div class="col-md-3">
										<form:radiobutton
							path="m_topType" id="m_topType" value="Slite" label="Slite" /> <form:radiobutton
							path="m_topType" id="m_topType" value="Flare" label="Flare" />
									</div>
									<div class="has-error">
							...
							<div class="row">
								<div class="form-group col-md-12">
									...
									<label class="col-md-2 control-lable" for="customerDetails">Customer Name</label>
									<div class="col-md-3">
									<label class="select"><form:select
							path="customerDetails" items="${customerDetailsList}" multiple="false"
