...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Short Codes <i class="fa fa-angle-right"></i>Typography</li>
            </ol>
<div class="agile3-grids">

<div class="wthree-typo">
				...
				<div class="sidebar-menu">
					<header class="logo1">
						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
									<ul id="menu" >
										<li><a href="index1.jsp"><i class="fa fa-tachometer"></i> <span>Home</span><div class="clearfix"></div></a></li>
