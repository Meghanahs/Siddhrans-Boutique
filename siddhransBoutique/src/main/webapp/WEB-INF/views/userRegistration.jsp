				...
				<fieldset>
					...
					<section> <label class="input"><i
						class="icon-append icon-user"></i> <form:input type="text"
							path="firstName" id="firstName" placeholder="First Name " /> <b
						class="tooltip tooltip-bottom-right">First name without
							Special Character</b> </label> </section>

					<section> <label class="input"><i
						class="icon-append icon-user"></i> <form:input type="text"
							path="lastName" id="lastName" placeholder="Last Name " /> <b
...
<%-- 
					...
					<section>Date Of Birth <label class="input"> </br> <form:input
							type="date" path="dob" />
					</label> </section>
